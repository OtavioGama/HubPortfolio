        ...
        <section className='banner'>
            <div className='banner-content medium-width'>
                <div className='banner-text'>
                    <h1 className='fadeInX from-left delay-1'>Otávio Gama</h1>
                    <h2 className='fadeInX from-left delay-2'>Desenvolvedor Web</h2>

                    <h3 className='fadeInX from-left delay-3'>Aqui se encontra minha trajetória de aprendizagem de codificação.</h3>
                </div>

                <div className='banner-links fadeInX from-right'>
