  ...
  return (
    <div className={styles['home']}>
        <section className={styles['banner']}>
            <div className={`${styles['banner-content']} ${styles['medium-width']}`}>
                <div className={styles['banner-text']}>
                    <h1 className={`${styles['fadeIn']} ${styles['from-down']} ${styles['delay-1']}`}>Otávio Gama</h1>
                    <h2 className={`${styles['fadeIn']} ${styles['from-down']} ${styles['delay-2']}`}>Desenvolvedor Web</h2>

                    <h3 className={`${styles['fadeIn']} ${styles['from-down']} ${styles['delay-3']}`}>Aqui se encontra minha trajetória de aprendizagem de codificação.</h3>
                </div>

                <div className={`${styles['banner-links']} ${styles['fadeIn']} ${styles['from-down']} ${styles['delay-1']}`}>
        ...
        <section className={styles['time-line']}>
            <div className={`${styles['time-line-content']} ${styles['medium-width']}`}>

                <h2 className={`${styles['fadeIn']} ${styles['from-down']} ${styles['delay-4']}`}> Projetos </h2>
